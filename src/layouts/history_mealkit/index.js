            ...
            <Card>
              ...
              <MDBox p={3}>
                <Grid container spacing={3}>
                  ...
                  >
                    Mealkit name: <strong>{product?.product_name}</strong>
                  </p>
                  ...
                  <Grid item xs={12}>
                    <MDTypography variant="h6" gutterBottom>
                      Price Update History and Discount Percentage of the Mealkit
                    </MDTypography>
